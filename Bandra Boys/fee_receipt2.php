...
<span style="font-size:1em;font-weight:300;">(CERTIFICATE COURSES) </span><br><br>
</div>
</center>
</div>
</div>
...
<p class "div-input1">Year &emsp;<span><b><?php echo $academic_year ;?></b></span> &emsp; Receipt No: <span><b></b></span> </p>
<p class="div-input1">
<span> G.R. No. :  &emsp;<b> <?php echo $gr_no; ?> </b></span> &emsp;
<span class="slip-input1"> Faculty: &emsp; <b></b> &emsp; </span>
</p><br><br>
<div style="text-align:left;float:left;width:97%;padding-left:3%;">Received From Mister/Ms: &emsp; <span class="slip-input1" style="min-width:344px;"><b><?php echo $first_name .'  '. $last_name;?></b></span></div><br><br>
...
<div style="float:left;padding-left:5%;">Date: <?php echo date('d-m-y'); ?>  &emsp; &emsp;  &emsp; &emsp;  Fees Clerk   _____________-</div><br><br>
