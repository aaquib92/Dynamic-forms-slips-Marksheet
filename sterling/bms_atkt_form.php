...
<div class="page-break main_div_bonafide">
	...
	<div style="text-align: left;">
		<p><span style="text-align: left;">Sir/ Madam ,</span><br>
			...
			</b> Examination <?=$academic_year;?> of  Bachelor of Management Studies 
		</p>
	</div>
	<div style="text-align:left;">
...
,'ORGANIZATIONL BEHAVIOUR & HRM'
,'BASICS OF FINANCIAL SERVICES ( ELECTIVE)'
,'CORPORATE  FINANCE ( ELECTIVE)'
,'RECRUITMENT & SELECTION ( ELECTIVE)'
,'MOTIVATION & LEADERSHIP ( ELECTIVE)'
];
