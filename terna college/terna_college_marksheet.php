...
elseif($marks >= 21 && $marks <= 32.99)    {$grade = 'E1'; return $grade; }
elseif($marks >= 33 && $marks <= 40.99)    {$grade = 'D'; return $grade; }
elseif($marks >= 41 && $marks <= 50.99)    {$grade = 'C2'; return $grade; }
elseif($marks >= 51 && $marks <= 60.99)    { $grade = 'C1'; return $grade; }
elseif($marks >= 61 && $marks <= 70.99)    { $grade = 'B2'; return $grade; }
elseif($marks >= 71 && $marks <= 80.99)    { $grade = 'B1'; return $grade; }
elseif($marks >= 81 && $marks <= 90.99)    { $grade = 'A2'; return $grade; }
...
$subj_name_compare = [
    'algebra' =>"mathematics",
    'maths_1' =>"mathematics",
    'science_1' =>"science & tech",
    'science_a' =>"science & tech",
    'history_&_civics' =>"social science" 
    ];

// $addin_subjs = ($global_arr['student_selected_class'][0]['rank'] > 80) ? ['hindi'=>'hindi','german'=>'german'] :['san' => 'Ind. Class/For. Lang'];
...
$subject_sequence =['english','hindi','marathi','french','german','sanskrit','maths','maths_1','maths_2','algebra','geometry',
'evs','evs_1','evs_2','science','science_a','science_b','science_1','science_2',
'social_science','history_&_civics','geography','science_a'];
...
<section>
    ...
    <div >
        ...
        <div class="academic_det">
            ...
            <h5 style="text-align: center;"><span style="border-radius: 20px;background:#f44336;padding:0.2rem 0.5rem;color: #fff"><?php echo $class_section ;?> SCHOOL</span></h5>
...
<div>
    ...
    if($stud_std == '9')
                ...
                $section_coordinator = "http://ternavidyalaya.org/media/1178/9th_coordinator_1.jpg";                
                $i=0;
                ...
                echo "<tr class='bord_tr'><td></td><td>MM</td><td>MO</td><td>MM</td><td>MO</td><td>MM</td><td>MO</td></tr>";
                ...
                //------------------------PRINTING SEM 1-------------------
                $arr_subj = str_replace(' ','_',(strtolower(trim($v_sem1['subject_name']))));
                if (isset($subj_name_compare[$arr_subj])) {
                    echo "<tr><td><b>".ucfirst($subj_name_compare[$arr_subj])."</b></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>";
                }
                ...
                echo ucfirst($v_sem1['subject_name']). "</td>";
                $total_marks_sem1=0;
                $max_marks_sem1=0;
                $subject_total=0;
                $tot_marks =0;
                ...
                $tot_marks = ($max_marks_sem1+$max_marks_sem2)/2;
                }
                    $percent2 =  (($max_marks_sem2 > 0) && ($total_marks_sem2 > 0)) ? ($total_marks_sem2/ $max_marks_sem2)*100 : 0;
                echo "<td>" .$v_sem2['total_marks']."</td>";
                echo "<td>" .$v_sem2['marks_obtained']."</td>";

                ($i<count($sem1)) ? $i++ : FALSE;

                //------------------------PRINTING TOTAL   SEM1 +  SEM2  -------------------
                echo "<td>".$tot_marks."</td><td>".round(($subject_total)/2) ."</td>";
                echo "</tr>";
                ...
                $percent_sem1 = ($grand_total_obt_sem1 != 0) ?round(calc_percent($grand_total_obt_sem1,$grand_total_max_sem1)) : 0;
                $percent_sem2 = ($grand_total_obt_sem2 != 0) ?round(calc_percent($grand_total_obt_sem2,$grand_total_max_sem2)) : 0;
                
                // $mo_percent_sem1 = round(calc_percent($grand_total_obt_sem1,$grand_total_max_sem1));
                $percent_sem2 = round(calc_percent($grand_total_obt_sem2,$grand_total_max_sem2));
                // $e_grade_sem2 = check_grade2(round(calc_percent($grand_total_obt_sem2,$grand_total_max_sem2)));


                $grand_obt = round(($grand_total_obt_sem1 + $grand_total_obt_sem2)/2);
                $grand_max = ($grand_total_max_sem1 + $grand_total_max_sem2)/2;
                $grand_percent = ($grand_obt != 0) ?round(calc_percent($grand_obt,$grand_max)) : 0;
                ...
                echo "<tr class='bord_tr'><td>GRAND TOTAL</td><td>". $grand_total_max_sem1 ."</td><td>$grand_total_obt_sem1</td><td>". $grand_total_max_sem2."</td><td>$grand_total_obt_sem2</td><td>$grand_max</td><td>$grand_obt</td>";
                echo "<tr class='bord_tr'><td>GRADE/PERCENTAGE</td><td></td><td>".$percent_sem1." %</td><td></td><td>".$percent_sem2."%</td><td></td><td>".$grand_percent."%</td>";

                echo "</table>";
            }
    //--------------------------------------REPORT CAR FOR 1st to 8th--------------------------------------             
      else{
        // echo print_array($sem1);
            $i=0;
            echo "<table class='subj_mrx_tab' style=''>";
            echo "<thead><th>SUBJECTS</th><th colspan='2'> TERM 1</th><th colspan='2'>TERM 2 </th><th colspan='2'> ANNUAL</th></thead>";
            ...
            if(count($co_scho_res)){
                ...
                if(isset($co_scho_res[$pc_id])) {
                    ...
                    foreach ($co_scho_tab as $k1 => $v1) {
                        $tds = "";$tot_tds = 0;
                        foreach ($v1 as $k2 => $v2) {
                            $tds .= ($k2 == "name") ? "<td>$v2</td>" : "<td>".check_grade(round($v2))."</td><td>".check_grade2(round($v2))."</td>";
                            $tot_tds += ($k2 == "name") ? 0 : $v2;
                        }
                        $tds .= (sizeof($v1) > 2) ? "" : "<td></td><td></td>";
                        // $tds .= "<td>".($tot_tds/2)."</td><td>".check_grade2($tot_tds/2)."</td>";
            ...
            $class_teach_sig = [
                "1A" => "http://ternavidyalaya.org/media/1172/1165-class-teacher-1a.jpg",
                "1B" => "http://ternavidyalaya.org/media/1173/1165-class-teacher-1b.jpg",
                "1C" => "http://ternavidyalaya.org/media/1171/1165-class-teacher-1c.jpg",
                "1D" => "http://ternavidyalaya.org/media/1170/1165-class-teacher-1-d.jpg",
                "2A" => "http://ternavidyalaya.org/media/1238/em_2a.jpg",
                "2B" => "http://ternavidyalaya.org/media/1239/em_2b.jpg",
                "2C" => "http://ternavidyalaya.org/media/1240/em_2c.jpg",
                "3A" => "http://ternavidyalaya.org/media/1241/em_3a.jpg",
                "3B" => "http://ternavidyalaya.org/media/1242/em_3b.jpg",
                "3C" => "http://ternavidyalaya.org/media/1243/em_3c.jpg",
                "4A" => "http://ternavidyalaya.org/media/1244/em_4a.jpg",
                "4B" => "http://ternavidyalaya.org/media/1245/em_4b.jpg",
                "4C" => "http://ternavidyalaya.org/media/1246/em_4c.jpg",
                "5A" => "http://ternavidyalaya.org/media/1247/em_5a.jpg",
                "5B" => "http://ternavidyalaya.org/media/1248/em_5b.jpg",
                "5C" => "http://ternavidyalaya.org/media/1249/em_5c.jpg",
                "6A" => "http://ternavidyalaya.org/media/1250/em_6a.jpg",
                "6B" => "http://ternavidyalaya.org/media/1227/em_6b.jpg",
                "6C" => "http://ternavidyalaya.org/media/1228/em_6c.jpg",
                "7A" => "http://ternavidyalaya.org/media/1229/em_7a.jpg",
                "7B" => "http://ternavidyalaya.org/media/1230/em_7b.jpg",
                "7C" => "http://ternavidyalaya.org/media/1231/em_7c.jpg",
                "8A" => "http://ternavidyalaya.org/media/1232/em_8a.jpg",
                "8B" => "http://ternavidyalaya.org/media/1233/em_8b.jpg",
                "8C" => "http://ternavidyalaya.org/media/1234/em_8c.jpg",
                "9A" => "http://ternavidyalaya.org/media/1235/em_9a.jpg",
                "9B" => "http://ternavidyalaya.org/media/1236/em_9b.jpg",
                "9C" => "http://ternavidyalaya.org/media/1237/em_9c.jpg",
            ];
            ...
            <tr><td>E2</td><td>Below 21</td><td> 5</td><td>Below 33</td><td>Req. Counselling</td>
            </tr>
            </tbody>
            </table>
...
<div id="remark_div" class="" style="text-align: justify;">
<?php echo $grades_arr[$grand_grade]; ?>
</div>

<h4 class="left_align">PART 5: REMARKS </h4>
<h6 class="left_align">Passed and Promoted To Grade/ Div. <input type="text" value="<?php echo $promote_to; ?>" style="width: 60px;border:0;border-bottom: 1px dotted #212121;"></h6>
...
<div style="width: 100%;display:flex;font-size:1rem;">
    ...
    <div style="width:33.33%;text-align:center;">
        <span style="border-top:1px dotted #212121;"><img height="55" width="90" src="http://ternavidyalaya.org/media/1166/mrssheeja-edelbert-principal.jpg" alt="princy"><br>Principal</span>
    </div>
</div>
</section>
