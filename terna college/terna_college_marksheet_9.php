...
$class_section = ($global_arr['student_selected_class'][0]['rank'] > 70) ? "SECONDARY" : "PRIMARY";
...
$addin_subjs = ['hindi'=>'hindi','german'=>'Composite Lang'] ;
...
$subject_sequence =['english','marathi','hindi','algebra','geometry','science_a','science_b','history_&_civics','geography_&_economics','french','german',
'sanskrit',];
...
// $a = "<tr><td>Mathematics</td></tr>";

// echo print_array($subject_sequence[4]);

    foreach ($subject_sequence as $k_sub => $v_sub)
    //  echo print_array($v_sub);
        ...
        foreach($array_data['data'] as $key_data => $data)
        {
            $arr_subj = str_replace(' ','_',(strtolower(trim($data['subject_name']))));
                ...
                if($v_sub == $arr_subj)
                {
                  ...
                  if(in_array($arr_subj,$addin_subjs)){ unset($addin_subjs[$arr_subj]);}
                }
        }
    }
...
.pt_marks,.subject_marks{margin-bottom:1%}td,th{border-right:1px solid #000}
    ...
    <div class="col-container" style="padding: 1px;border: 1px solid #212121;border-radius: 7px;font-size:70%">
        <div class="col-div" style="text-align:left;    padding: 1%;">
                ...
                <div class="row-div">
                    ...
                    <span class="column inp_head" >:<u><b class="att_perc" contenteditable='true' > &emsp;&emsp;&emsp; </b></u>
...
<h6 class="left_align">Passed and Promoted To Grade/ Div. <input type="text" style="width: 60px;border:0;border-bottom: 1px dotted #212121;"></h6>
<h6 class="left_align">The School Re-opens On <input type="text" value="15 June 2018" style="width: 100px;border:0;border-bottom: 1px dotted #212121;"></h6>

<br>
<div style="width: 100%;display:flex;font-size:1rem;">

    <div style="width:33.33%;text-align:center;">
        <span style="border-top:1px dotted #212121;"><img height="55" width="90" src="<?php echo $class_teach_sig;?>" alt="class_tech"><br>Home Room Teacher</span>
    </div>
    <div style="width:33.33%;text-align:center;">
        <span style="border-top:1px dotted #212121;"><img height="55" width="90" src="http://ternavidyalaya.org/media/1169/signatures_6.jpg" alt="sec_coord"><br>Section Coordinator</span>
    </div>
    <div style="width:33.33%;text-align:center;">
