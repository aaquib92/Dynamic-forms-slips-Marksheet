 ...
 <span style="font-size:0.8em;font-weight:400;">Near Anjurphata, Opp. Bhiwandi Road Railway Station, Bhiwandi - 421305. Ph. 278201, 278133</span><br>
  <span style="font-weight:600;font-size:1.1em;">LEAVING CERTIFICATE </span><br>
	   ...
	   <div><span style="float:left; font-weight:400; width:20%;font-size:0.8em;"><b>Serial No : _________</b></span><span style="float:right;font-weight:400; width:30%;font-size:0.8em;"><b>Register No:</b><span class="slip-input1"<?php echo $gr_number ;?>></span></span></div><br><br>
         ...
         <div style="text-align:left;float:left;width:97%;padding-left:3%;"> 1) Name of the pupil in full &emsp;  <span class="slip-input1"><?php echo $stud_roll ;?> &emsp;&emsp;&emsp; <span class="slip-input1"><?php echo $stud_name ;?></span></div><br><br>
         <p class="div-input1"> 2) Caste & sub-caste, only in the case of pupil belonging to Backward class & category </p><br><br>
         <p class="div-input1"> among Back class (e.g. S.C./S.T.)<span class="slip-input1"><?php echo $caste ;?></span> </p><br><br>
         <p class="div-input1">3) Place of Birth  &emsp;<span class="slip-input1"><?php echo $place_of_birth ;?></span> </p><br><br>
         <p class="div-input1">4) Date of Birth (according to the christian era, both in words & figure &emsp;  <span class="slip-input1"><?php echo $dob ;?></span> </p><br><br>
         <p class="div-input1"><span class="slip-input1"></span> </p><br><br>
         <p class="div-input1">5) Last School Attended &emsp; <span class="slip-input1"></span> </p><br><br>
