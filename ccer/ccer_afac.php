...
<?php 
         ...
         $sem1_e_fr = isset($sem1_frmt_exam_name) ? (count($sem1_frmt_exam_name) + 1) : 1; 
...
echo "<th class ='th_class'></th><th class ='th_class' colspan ='$sem1_e_sm'></th>";
...
//  echo print_array($sem1_exm_name);
 ...
 foreach ($sem1 as $k => $v) {
      ...
      $sem1_table .= "<td class ='td_class center'>".$max_marks_tot_sem1_frm."</td>";
        ...
        $sem1_table .="<td class ='td_class center'>".$max_marks_tot_sem1_sm."</td><td class ='td_class center'>".$grand_max_tot_sem1."</td><td class ='td_class'></td></tr><tr>";
        ...
        if(isset($co_scho_res[$pc_id]['1']) && (sizeof($co_scho_res[$pc_id]['1'])> 0))
                {
                        ...
                        foreach($co_scho_res[$pc_id]['1'] as $k => $v) {
                             ...
                             $sem1_table.="<tr><td class ='td_class center' rowspan ='2'>".++$serial_no."</td><td class ='td_class' rowspan ='2'>".$v['curriculum_name']."</td>";
                            ...
                            // formative td for  marks obtained
                             ...
                             if(sizeof($sem1) > 0)
                             {
                                     ...
                                     $sem1_table.="<td class='td_class center'>".$v['grade']."</td><td class='td_class'></td><td class='td_class'></td><td class='td_class'></td><td class='td_class'></td><td class='td_class'></td><td class='td_class'></td></tr>";
                             }
