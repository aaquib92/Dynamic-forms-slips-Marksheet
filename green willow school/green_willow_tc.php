...
.slip-input1 {
 ...
 <div class="leaving-certificate-div">
  ...
  <span style="font-size:1.3em;font-weight:700;"><?php echo $stud_school_addr ;?></span><br>
   <span style="font-size:1em;margin-right:-1%">Mob.+91-8006000770,+91-9917200000,0565-2431070,71,72</span><br><br>
                ...
                <div class="div_tab">
                    ...
                    <div class="div_tab_row"><!--row-->
                        ...
                        <div class="div_tab_row"><!--row-->
                            ...
                            <div class="div_tab_col2">
                              : &nbsp;<span class="slip-input1">2131688</span>  &emsp; 
                            </div>
                            <div class="div_tab_col1">
                                Renewed upto  &emsp;  
                            </div>
...
<hr style="border:1px solid black;">
         ...
         <div style="text-align:left;float:left;width:97%;padding-left:3%;border-bottom:thin solid #ddd;" class="div-input1">2. Mother's Name: &emsp; <span><?php echo $mother_name ;?></span> </div><br>
         ...
         <div style="text-align:left;float:left;width:97%;padding-left:3%;border-bottom:thin solid #ddd;" class="div-input1">6. Date of Birth (according to the admissionn Register(and / in figure): &emsp;  <span><?php echo $newDate ;?></span> </div><br>
           <div style="text-align:left;float:left;width:97%;padding-left:3%;border-bottom:thin solid #ddd;" class="div-input1">( in words): &emsp;  <span></span> </div><br>
         ...
         <div style="text-align:left;float:left;width:97%;padding-left:3%;border-bottom:thin solid #ddd;" class="div-input1">12.  Whether the pupil has paid all dues to the school: &emsp; <span></span> </div><br>
         ...
         <div style="text-align:left;float:left;width:97%;padding-left:3%;border-bottom:thin solid #ddd;" class="div-input1">15.  Date on which pupils name was stuck off the rolls of the School: &emsp; <span></span> </div><br>
         <div style="text-align:left;float:left;width:97%;padding-left:3%;border-bottom:thin solid #ddd;" class="div-input1">16.  Reason for leaving the school: &emsp; <span></span> </div><br>
