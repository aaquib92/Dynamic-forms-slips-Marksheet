...
{
  $doc_id = $data['id'];
  $serial_no = isset(get_partner_documnets_log_count()[$doc_id]) ? get_partner_documnets_log_count()[$doc_id] : 0;
}
...
$admission_year   = date("d-m-Y", strtotime( (isset($global_arr['student_details'][0]['admission_year']) && !empty($global_arr['student_details'][0]['admission_year']))?''.$global_arr['student_details'][0]['admission_year'].'':''));
...
if(isset($global_arr['student_details'][0]['custom_fields'])){
   if(sizeof($global_arr['student_details'][0]['custom_fields'])){
       $custom_fields = json_decode($global_arr['student_details'][0]['custom_fields'],true);
   }
}//  echo print_array($custom_fields);die();
$mother_tongue = isset($custom_fields['mother_tongue']) ?  $custom_fields['mother_tongue'] : '';
$c_student_id = isset($custom_fields['c_student_id']) ?  $custom_fields['c_student_id'] : '';
$c_nationality = isset($custom_fields['c_nationality']) ?  $custom_fields['c_nationality'] : '';
$previous_school_attended = isset($custom_fields['previous_school_attended']) ?  $custom_fields['previous_school_attended'] : '';
$previous_school_standard = isset($custom_fields['previous_school_standard']) ?  $custom_fields['previous_school_standard'] : '';
$standard_in_which_admitted = isset($custom_fields['standard_in_which_admitted']) ?  $custom_fields['standard_in_which_admitted'] : '';
...
<?php 
 $serial_no_count = 766 + (( isset($serial_no['count'])) ? (int)$serial_no['count'] : 0 );
 $serial_no_count = str_pad($serial_no_count,6,"0",STR_PAD_LEFT);
...
?>
 ...
 <div class="head-div">
         ...
         <center style="line-height:1.2em;">
             <span style="font-weight:600;font-size:1.4em"><?php echo $stud_school_name ?></span><br>
             ...
             <span style="font-size:0.8em;font-weight:300;"><?php echo $stud_school_addr; ?></span><br>
           ...
           <div><span style="font-weight:400;font-size:0.9em;">(No change in any entry in this certificate shall be made except by the authority issuing it and any</span><br><span style="font-weight:400;font-size:0.9em;"> infringement this requirement is liable to involve the imposition of penalty such as that of rustication )</span></div>
    </div><br>
    <!--end of head -->
    <!--start of tab container-->
          ...
          <div style="display:table;width:100%">
                        ...
                        <div class="box box1" style="    text-align: center;" >
                          U-Dise No   : &nbsp; <input type ="text" class ="common_input  browser-default" >
                        </div>
...
$previous_school_standard
$standard_in_which_admitted -->



                        <div class="box ">

                                <div class="content">:&nbsp;<div contenteditable="true" ><?php echo $c_student_id ; ?> </div></div>
                                ...
                                <div class="content">:&nbsp;<div  contenteditable="true"> <?php echo $c_nationality ;?> </div> </div>
                                <div class="content">:&nbsp;<div contenteditable="true"><?php echo $mother_tongue ;?> </div> </div>
                                ...
                                <div class="content">:&nbsp;<div contenteditable="true" > <?php echo $previous_school_attended;?></div>&emsp;&emsp; Std <div contenteditable="true">:<?php echo $previous_school_standard;?> </div>   </div>
                                <div class="content">:&nbsp;<div contenteditable="true" ><?php echo $admission_year;?> </div> </div>
                                <div class="content">:&nbsp;<div contenteditable="true" ><?php echo $standard_in_which_admitted;?>     </div> </div>
