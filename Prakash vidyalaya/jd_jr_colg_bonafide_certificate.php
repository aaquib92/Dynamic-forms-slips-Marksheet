    ...
    <div class="head-div">
         <center style="padding-top:2%">
            <img class="left"  width="100" height="100" src="<?php echo $stud_school_logo ; ?>" >
             ...
             <span style="font-size:1.6em;font-weight:700;">J.D Junior College of Commerce</span><br>
             <span style="font-size:1em;font-weight:300;"><?php echo $stud_school_addr ;?></span><br><br>
             <span style="font-weight:600;font-size:1.3em;"><u>BONAFIDE CERTIFICATE</u></span><br>
         </center>
    </div><br><br>
...
<p class="div-input1 size"> is / was a bonafide student of this college studying in </p><br><br><br>
<p class="div-input1 size">Std <span class="slip-input1"><?php echo $stud_std ;?></span> Div  <span class="slip-input1"><?php echo $stud_div  ;?></span> in the year <span class="slip-input1"><?php echo $academic_year ;?></span> &nbsp;His/Her</p><br><br><br>
<p class="div-input1 size"> date of birth as recorded in the General Register of this College</p><br><br><br>
<p class="div-input1 size">is <span class="slip-input1"><?php echo $stud_dob ;?></span> &emsp;He/She is/ was regualar in atten- </p><br><br><br>
<p class="div-input1 size">dance To the best of my knowledge he /she bears a good moral </p><br><br><br>
<p class="div-input1 size">character </p><br><br><br>
<p style="float:right; font-weight:bold; padding-right:3%;">Head of the College</p>
