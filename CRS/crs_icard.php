...
#grad1 {
    ...
    background: -webkit-linear-gradient(cyan, white); /* For Safari 5.1 to 6.0 */
    background: -o-linear-gradient(cyan, white); /* For Opera 11.1 to 12.0 */
    background: -moz-linear-gradient(cyan, white); /* For Firefox 3.6 to 15 */
    background: linear-gradient(cyan, white); /* section syntax (must be last) */
}
.tab_container {
   text-align:left;
    max-width: 70%;
 ...
 <!--header-->
     <div id="grad1">
                <div class="head_div"> <img  width="45" height="50" src="<?php echo $stud_school_logo ; ?>">
                                ...
                                <center>
                                    <span style="font-weight:500;font-size:1.2em; text-shadow: 1px 1px red; color:red;"><?php echo $stud_school_name ;?></span><br>
                                  <span style="font-size:1em;font-weight:700;">(CBSE Affiliation No.11800013)</span><br>
                                    <span style="font-size:1em;font-weight:700;"><?php echo $stud_school_addr ; ?></span><br>
                                     <span style="font-size:0.8em;font-weight:700;">Tel:91-251-2327347, Email:principal@crskyn.org</span><br>
                                     <hr style="border:1px solid #1565C0;"> <div style=" margin-top:-4%;padding:0.1%; width:42%; height:7%; color:white; background-color: #1565C0; border:2px solid #1565C0;border-radius:4px; font-weight:500;">IDENTITY CARD <?php echo $academic_year;?></div>
                                </center>
                </div>
     </div>
     <!--end-->
...
<div class="main-content" style="padding: 3%;" >
     ...
     '';?>"><br>
     <img width="75" height="27" src="<?=base_url()?>/assets/22/images/Jacob_Sign.jpg" alt=""><br><b>Principal Signature &emsp;&emsp;</b>
